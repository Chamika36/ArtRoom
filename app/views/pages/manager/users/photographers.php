                    ...
                    <?php foreach ($data['photographers'] as $photographer) : ?>
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo URLROOT; ?>/users/edit/<?php echo $photographer->UserID; ?>">
                                        <i class="fas fa-pencil-alt edit-icon"></i> <!-- Edit icon -->
                                    </a>
                                </td>
                                <td>
                                    <a href="<?php echo URLROOT; ?>/users/delete/<?php echo $photographer->UserID; ?>" onclick="return confirm('Are you sure you want to delete <?php echo $photographer->FirstName ?>');">
