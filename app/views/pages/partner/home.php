            ...
            <ul class="box-info">
				<!--<a href="<!?php echo URLROOT ?>/events">-->
					<li>
						...
						<span class="text">
							<h3>5<!--<!?php echo is_array($data['eventCount']) ? count($data['eventCount']) : $data['eventCount']; ?>--></h3>
				...
				<!--<a href="<!?php echo URLROOT ?>/events">-->
					<li>
						...
						<span class="text">
							<h3>3<!--<!?php echo is_array($data['requestCount']) ? count($data['requestCount']) : $data['requestCount']; ?>--></h3>
							<p>Ongoing Events</p>
						</span>
					</li>
				<!--</a>-->
